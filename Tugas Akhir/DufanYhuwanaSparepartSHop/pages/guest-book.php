...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/style-guestbook.css" type="text/css">
    <title>Dufan Yuwana Speed Shop</title>
  </head>
  <body>
 ...
 <!--start navbar-->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Dufan Yuwana Speed Shop</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active " href="#"aria-current="page">Buku Tamu</a>
          </li>
        </ul>
        <form class="d-flex">
      ...
      <div class="container">
        <div class="row mt-2">
          ...
          <div class="col-md-6 text-md-end text-center pt-2 pb-2">
            <a
              href="https://www.instagram.com/dufanachmd_/"
            ...
            <a
              href="https://wa.me/085728218681?text=halooo%20gaesss"
              class="text-decoration-none"
            >
              <img
                class="ms-2"
